...
#include <jni.h>
/* Header for class com_atguigu_javacallc_JNI */

#ifndef _Included_com_atguigu_javacallc_JNI
#define _Included_com_atguigu_javacallc_JNI
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: (II)I
 */
JNIEXPORT jint JNICALL Java_com_atguigu_javacallc_JNI_sum
